    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ marginTop: 10, flex: 1, marginHorizontal: 25 }}>
        ...
        <View style={{ justifyContent: "space-between", flexDirection: "row", marginVertical: 20 }}>
          <Text style={{ fontSize: 17, textAlignVertical: "center" }}>Items Choosen</Text>
...

{
        products == !cartnotification
              ?
              <View style={{flex:1,justifyContent:"flex-start",alignItems:"center",paddingVertical:130}}>
              <Image source={require("../../assets/themePics/emptycart.png")} style={{resizeMode:"contain",position:"absolute",width:"100%",height:"150%",}}/>
              </View>
              :        
                <TouchableOpacity style={{ backgroundColor: "#ffcc00", width: "100%", height: 100, borderRadius: 25, justifyContent: "center", marginBottom: 20, }}>
                  <Text style={{ textAlign: "center", textAlignVertical: "center", fontSize: 17, color: "black", fontWeight: "bold" }}>Checkout</Text>
                </TouchableOpacity>  
}
      </View>
    </View>
