...
export const Burger = () => {
  ...
  return (
    <View style={{backgroundColor:"#fcfcfc",flex:1}}>
      ...
      <View>
        <Text style={{fontSize:39,color:"black",fontWeight:"bold",paddingLeft:25}}>Crunchy {"\n"}Cheesy Burger</Text>
        <Text style={{fontSize:39,color:"#5650ac",fontWeight:"bold",paddingLeft:25,paddingVertical:10}}>4.25$</Text>
        <Image source={require("../../assets/themePics/burger.png")} style={{height:200,resizeMode:"contain",position:"absolute",top:150,left:20}}/>
