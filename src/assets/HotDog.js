...
export const HotDog = ({route}) => {
  ...
  return (
    <View style={{backgroundColor:"#fcfcfc",flex:1,height:height,width:width}}>
      ...
      <View style={{paddingTop:40}}>
        <Text style={{fontSize:39,color:"black",fontWeight:"bold",paddingLeft:25}}>Hot Dogs</Text>
        <Text style={{fontSize:39,color:"#5650ac",fontWeight:"bold",paddingLeft:25,paddingVertical:10}}>4.25$</Text>
        <Image source={require("../../assets/themePics/roll.png")} style={{height:200,resizeMode:"contain",position:"absolute",top:130,left:-6,}}/>
      ...
      <Text style={{fontSize:40,color:"white",paddingTop:10,opacity:1,}}>180</Text>
