...
export const Donut = ({route}) => {
  ...
  return (
    <View style={{backgroundColor:"#fcfcfc",flex:1}}>
      ...
      <View>
        <Text style={{fontSize:39,color:"black",fontWeight:"bold",paddingLeft:25}}>Sprinkle {"\n"}Cakes</Text>
        <Text style={{fontSize:39,color:"#5650ac",fontWeight:"bold",paddingLeft:25,paddingVertical:10}}>4.25$</Text>
        <Image source={require("../../assets/themePics/donut.png")} style={{height:400,resizeMode:"contain",position:"absolute",top:60,left:180}}/>
