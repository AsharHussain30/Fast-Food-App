import { Button, StyleSheet, ScrollView, Text, TouchableOpacity, View, Image, Animated, TouchableOpacityBase, Dimensions } from 'react-native'
...
export const Hexagon = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Animated.View style={{ flex: 1, margin: 0, left: 0, right: 0, top: 0, bottom: 0, position: "absolute", borderTopLeftRadius: showMenu ? 80 : 0, borderBottomLeftRadius: showMenu ? 80 : 0, borderColor: showMenu ? "white" : "transparent", borderWidth: 2, padding: showMenu ? 22 : 0, backgroundColor: "white", transform: [{ scale: scale }, { translateX: moveToRight, }] }}>
        <ScrollView style={{ padding: height / 60 }}>
          ...
          <View style={{ marginTop: 100, flex: 1 }}>
            ...
            <View style={{ backgroundColor: "#baa2e1", height: 205, width: "100%", borderRadius: 25, marginTop: 25, paddingVertical: 35, paddingHorizontal: 25, borderBottomWidth: 14, borderBottomColor: "#ece1ff", }}>
            ...
            <View style={{ justifyContent: "space-between", flex: 1, flexDirection: "row", paddingVertical: 20, }}>
              ...
              <TouchableOpacity onPress={() => Forward.transitionTo("animate")} style={{marginLeft:-190}}>
